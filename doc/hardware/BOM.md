...
|---|---|---|
| 1 | 19" Rack Mount Case | I am using a very cheap case "SIN 4 HE SW" |
| 1 | IEC connector with integrated EMI filter, 6A | KMF 1.1161 is what I am using | 
...
| 1 | Meanwell HRPG-600-24 | I use this model, since multiple power supplies can be connected in parallel in case 600W is not enough. Moreover, this power supply can be deactived by the raspberry to save some energy |
